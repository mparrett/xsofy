# Perf lane map, as of 2026-09-15 05:03 UTC

Perf, bench, ratchet, and CI-timeline issues and PRs Matt touched in nooga/let-go and nooga/xsofy

Counts as of 2026-09-15 05:03 UTC: 175 nodes, 399 references. Edges are `#`-references in bodies and comments; the **related** column is the same data. Interactive map: `~/projects-new/3p/joint-xsofy/perf-lane-map/index.html`.
...
| [#528](https://github.com/nooga/let-go/issues/528) | issue | open | 2026-07-16 | mparrett | Epic: Maintenance debt — retire superseded mechanisms, reduce process weight | #464, #531, #544, #558, #574, #575, #581 | ecosystem-health-audit-2026-07, letgo-simplification-audit |
...
| [#581](https://github.com/nooga/let-go/issues/581) | issue | open | 2026-07-19 | mparrett | CI: coverage gaps, a 3× stdlib compile per PR, and gates documented as CI-run that aren&#x27;t | #522, #528, #573, #583, #876, #878, #882 | ecosystem-health-audit-2026-07, letgo-ci-waste-review, letgo-timeline-leg-stoptimer-overhead |
...
| [#878](https://github.com/nooga/let-go/pull/878) | PR | open | 2026-09-14 | mparrett | ci(perf): lower the ubuntu perf capture cap to 60 minutes, provisionally | #581, #583, #876, #882 | letgo-ci-90s-target-and-go127, letgo-ci-cost-cadence-2026-09, letgo-timeline-leg-stoptimer-overhead |
...
| [#597](https://github.com/nooga/let-go/issues/597) | issue | open | 2026-07-21 | mparrett | perf-page: capture the release reference per machine tier so &quot;% vs v1.8.0&quot; is comparable a | #236, #238, #328, #329, #363, #445, #561, #564, #651, #663, #684, #693, #705, #740, #752, #791, #795, #876, #879, #880 | letgo-684-baseline-reseed, letgo-ci-90s-target-and-go127, letgo-ci-cost-cadence-2026-09 |
| [#621](https://github.com/nooga/let-go/pull/621) | PR | merged | 2026-07-22 | mparrett | bench(compiler): distinguish execution entry modes | #619, #620 | letgo-gloat-fib-probe-618-619 |
...
| [#882](https://github.com/nooga/let-go/pull/882) | PR | merged | 2026-09-15 | mparrett | bench(vm): hoist per-iteration setup out of the vector benchmark loops | #573, #581, #876, #878, #883, #884 | letgo-timeline-leg-stoptimer-overhead |
...
| [#464](https://github.com/nooga/let-go/issues/464) | issue | open | 2026-07-13 | nnunley | Epic: Runtime performance &amp; concurrency | #397, #503, #522, #528, #544, #559, #560, #563, #564, #567, #568, #569, #571, #619, #620, #644, #663, #705 | letgo-micro-opt-audit, letgo-simplification-audit, lgb-compression-lgbz |
...
| [#620](https://github.com/nooga/let-go/issues/620) | issue | open | 2026-07-22 | nnunley | Design: constant-space tail calls on the explicit-frame VM (closures, multi-arity, apply) | #425, #464, #618, #619, #621, #644, #645, #646, #691, #700, #720, #722 | feedback-search-the-mechanism-not-the-symptom, letgo-645-invoke-regression, letgo-boundary-abi-program |
...
| [#700](https://github.com/nooga/let-go/issues/700) | issue | open | 2026-08-08 | mparrett | vm: bytecode invoke is ~1.7x costlier since #645 (explicit frame chain) | #618, #620, #639, #644, #645, #646, #656, #686, #691, #706, #719, #720, #722, #723, #726, #727, #730, #794 | letgo-645-invoke-regression, letgo-boundary-abi-program, perf-lane-map-inventory |
...
| [#440](https://github.com/nooga/let-go/pull/440) | PR | merged | 2026-07-11 | nnunley | feat(ir): loop-fusion (deforestation) — pass, enabled, comp-chains + into |  | letgo-loop-fusion-440 |
...
| [#558](https://github.com/nooga/let-go/pull/558) | PR | merged | 2026-07-18 | mparrett | perf(ir): move inferred types to a positional side table — ~100x faster type writes | #528, #561, #564, #574, #575, #578, #601 | letgo-lgbdump-void-strip, letgo-micro-opt-audit, letgo-typeinfer-perf-audit |
...
| [#874](https://github.com/nooga/let-go/pull/874) | PR | merged | 2026-09-13 | mparrett | docs(design): propose the glplat host-capability seam and backend contract | #392, #744 | letgo-744-glplat-default-deps-gate |
